...
bool show_raw_data_browser=false;
bool save_raw_diameter=false;

int billet_max_entries=180000; // default 180000 is 5 minutes
...
//! [constructor]
MainWindow::MainWindow(quint16 port, bool debug, QObject *parent) :
    QObject(parent),
...
//    connect(pSocket, &QWebSocket::binaryMessageReceived, this, &MainWindow::processGetConfigBinaryMessage);
//    connect(pSocket, &QWebSocket::textMessageReceived,this,&MainWindow::processTestTextMessage);
...
//! [processTestTextMessage]
void MainWindow::processTestTextMessage(QString message)
{
    QWebSocket *pClient = qobject_cast<QWebSocket *>(sender());
    if (m_debug)
        qDebug() << "Test Message received: " << message;
    if (pClient){
        pClient->sendTextMessage(QStringLiteral("YA!"));
    }
    qDebug() << "Test Message received from outsides: " << message;
}
//! [processTestTextMessage]

// initial read setting
...
//    }
    ...
    qDebug()<<"122_SAVE_RAW_DIAMETERS"   << save_raw_diameter;
...
// Log
// Main Log
//void MainWindow::writeMainLog(QString string)
//{
//    mainLogger->local_write(string);
//}


//void MainWindow::processGetConfigBinaryMessage(QByteArray message)
//{
//    if (m_debug)
...
//    PresetMainWindow.speed                   = 20;
//    PresetMainWindow.ova_tolerance           = 0.2;
//    PresetMainWindow.ova_warning             = 0.1;
//    PresetMainWindow.tolerance_high          = 11; // this is called "nominal" in asymmetric_percentage mode
//    PresetMainWindow.tolerance_high_warning  = 10.5;
//    PresetMainWindow.tolerance_middle        = 10.0;
//    PresetMainWindow.tolerance_low_warning   = 9.5;
//    PresetMainWindow.tolerance_low           = 9;
...
//    QDataStream out(&getConfig, QIODevice::WriteOnly);
//    out.setVersion(QDataStream::Qt_5_10);

//    out << AxisNum << PresetMainWindow.speed << PresetMainWindow.ova_tolerance
//        << PresetMainWindow.ova_warning << PresetMainWindow.tolerance_high
//        << PresetMainWindow.tolerance_high_warning << PresetMainWindow.tolerance_middle
//        << PresetMainWindow.tolerance_low_warning << PresetMainWindow.tolerance_low;

//    //Sending to WebApp
//    QWebSocket *pClient = qobject_cast<QWebSocket *>(sender());
//    if (pClient) {
//        pClient->sendBinaryMessage(getConfig);
//    }
//}
...
{
    qInfo("Entry to socketDisconnected function");
    QWebSocket *pClient = qobject_cast<QWebSocket *>(sender());
    if (m_debug)
